...
- **OEIS identification** of the new 2D sequences — e.g. `(h=3, g=2) = 3, 9, 22, 51, 121, 292, 704, 1691, …` — and whether any carry an existing interpretation.
