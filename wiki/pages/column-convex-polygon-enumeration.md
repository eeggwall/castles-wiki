...
sources: [column-convex-polygon-enumeration, klarner-rivest-1974-convex-n-ominoes]
created: 2026-09-13
updated: 2026-09-19
---
...
- [[stack-polyomino-gf](pages/stack-polyomino-gf.md)] — the "stack polyominoes" family this paper names, given a direct ordinary generating function (OGF) via the [[symbolic-method](pages/symbolic-method.md)] in Example I.8 of [[analytic-combinatorics-ch1-ogfs](pages/analytic-combinatorics-ch1-ogfs.md)] — a specification-driven alternative to this paper's add-a-column functional equation, applicable when the class has enough structure (like the unimodal skyline of a stack polyomino).
