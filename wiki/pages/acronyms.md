...
- **COD** - convex-odd castles by area: convex castles of area `n` with an odd block count. Paired with CEV. Written `cod(n)` in formulas.
...
- **HC** - horizontally convex (polyomino).
...
- **PE** - Project Euler. "PE 502" = Project Euler problem 502, the castle-counting problem.
...
- **UA** - User-Agent (HTTP request header).
- **XTR** - subgroup-trace cryptosystem (Lenstra-Verheul, 2000).
