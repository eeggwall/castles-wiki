...
- [[analytic-combinatorics-ch1-ogfs](pages/analytic-combinatorics-ch1-ogfs.md)] — Flajolet–Sedgewick's symbolic-method framework: the general specification-to-OGF dictionary above the recurrence-first apparatus of the other two sources.
