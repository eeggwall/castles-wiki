...
| directed convex, convex | two boundaries, two phases each | not derived here, and no source for it has been read (see "Sources not yet read") [^7] |
