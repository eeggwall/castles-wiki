...
- [[castle-classification-non-geometric](pages/castle-classification-non-geometric.md)] - Axis 8, where a strip's growth constant classifies its castle class ("`<metal>` width growth castle").
