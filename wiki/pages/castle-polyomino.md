...
- [[castle-classification](pages/castle-classification.md)] - the hub for castle sub-family typing, split into geometric types ([[castle-classification-geometric](pages/castle-classification-geometric.md)]: the 42 skyline predicates across Axes 1-7) and non-geometric types ([[castle-classification-non-geometric](pages/castle-classification-non-geometric.md)]: Axis 8 growth type of a class, Axis 9 spectrum of the castle graph, compressibility).
