...
- [[convex-polyomino-by-area](pages/convex-polyomino-by-area.md)] - Klarner-Rivest constant `μ = 2.30913...` is the same `1/y_c(1)` that PB uses in the tricritical scaling.
