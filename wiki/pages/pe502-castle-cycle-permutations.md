...
- [[castle-classification-geometric](pages/castle-classification-geometric.md)] — rainbow castles (skyline = permutation) and the even-peak type (the block ≠ peak caveat as a predicate).
