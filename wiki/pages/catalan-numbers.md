...
- [[analytic-combinatorics-part-a](pages/analytic-combinatorics-part-a.md)] — §I.2 pp. 33-35 gives the canonical symbolic-method derivation `G = Z × SEQ(G)` → `G(z) = (1−√(1−4z))/2`; Figure I.2 p.20 recounts the prehistory (Euler, Segner, Lamé, Catalan).
